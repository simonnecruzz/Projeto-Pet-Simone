class PetApi
  def pet_get_idi(id_pet)
    #TODO para que serve esse metodo? Ele não esta sendo chamado em nenhum canto. Poderia deletar?
...
#TODO Poderia usar uma variavel de classe ou um construtor para guardar a URI
